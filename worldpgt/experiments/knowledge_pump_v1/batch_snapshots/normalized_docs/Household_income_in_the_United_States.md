...
Retrieved at: 2026-06-23T00:50:10Z
Revision ID: 1354923621
Raw text SHA256: 95bf5fedc3c31fbe9e4ccfb104c1b81fbeac8e3349804402072e9dcd04677172
...
The Great Recession began with the bursting of the 2000s United States housing bubble, which led to the subprime mortgage crisis. This in turn triggered the 2008 financial crisis. In constant price, 2011 American median household income was 1.13% lower than what it was in 1989. This corresponds to a 0.05% annual decrease over a 22-year period. In the meantime, GDP per capita has increased by 33.8% or 1.33% annually.
...
As of 2019, the median household income ranged from $20,474 in Puerto Rico to $92,266 in the District of Columbia. Note that the U.S. Census Bureau treats Puerto Rico as if it were a state (Puerto Rico is included in the ACS).
All data is from the 2009–2019 and 2013 ACS 1-Year estimates.
...
Below is the median household income for the U.S. territories in 2010 (for four of the five inhabited territories). Note that Puerto Rico is not included in this table, and is instead included in the table above (because Puerto Rico is included in the ACS, as if it were a state).
...
Distribution of household income in 2024 according to US Census data
