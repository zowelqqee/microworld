...
Source: https://en.wikipedia.org/wiki/Automatic_identification_system
Retrieved at: 2026-06-22T21:17:07Z
Revision ID: 1359470788
Raw text SHA256: 4521a0e63cb151804ba95ef8b9ff7bbdc73e6d58734e5d9221adfb4651f940f5
...
T-AIS refers to communication between ships and between ships and near-coast land stations. T-AIS range is approximately limited by line of sight, typically to a maximum of about 74 kilometres (46 mi) and for a land based station visibility is lost beyond coastal waters. In addition to port and maritime authority operated transceivers, there is large network of privately owned ones as well.
...
Typical NMEA 0183 standard AIS message: !AIVDM,1,1,,A,14eG;o@034o8sd062D,0*7D
In order:
...
Automatic Identification System (AIS) Overview | Navigation Center US Coast Guard general explanation of AIS and terms
...
Marine Traffic - Web based worldwide AIS tracking site that is free (advertiser supported) for casual use but costs for automated or advanced usage
VesselFinder - Web based worldwide AIS tracking site that is free (advertiser supported) for casual use but costs for automated or advanced usage
AIShub - Web based worldwide AIS tracking site that is free use for people contributing to it using their own equipment
