...
Source: https://en.wikipedia.org/wiki/Aggregate_demand
Retrieved at: 2026-06-23T20:35:06Z
Revision ID: 1351817888
Raw text SHA256: 65ee6f3c16d1add93ab20cabc4065d6e4fa2aded5f0b8d7e651626193de63fa5
...
Keynes credited Thomas Robert Malthus for recognizing the importance of aggregate demand. He blamed David Ricardo for causing English economists to overlook its importance, while praising Karl Marx, Silvio Gesell, and C. H. Douglas for spreading the concept.
...
) or "consumption", demand by households and unattached individuals; its determination is described by the consumption function. A basic conception is that it is the total consumption expenditures of the domestic economy. The consumption function is
...
{\displaystyle C=C_{0}+c\times (Y-T)}
...
), such as spending by business firms on factory construction. This is conceived as all private sector spending aimed at the production of some future consumable.
...
)), net demand by the rest of the world for the country's output. This contributes to the current account.
