...
the Goldstone Deep Space Communications Complex (35°25′36″N 116°53′24″W) about 60 kilometres (37 mi) north of Barstow, California. For details of Goldstone's contribution to the early days of space probe tracking, see Project Space Track;
...
Sources
This article incorporates public domain material from R. Corliss, William (June 1974). NASA Technical report CR 140390, Histories of the Space Tracking and Data Acquisition Network (STADAN), the Manned Space Flight Network (MSFN), and the NASA Communications Network (NASCOM) (PDF). NASA. hdl:2060/19750002909. Archived (PDF) from the original on 2022-03-03.

References

Notes
The sun orbiting Ulysses' extended mission operation terminated June 30, 2009. The extension permitted a third flyby over the Sun's poles in 2007–2008.
...
Further reading
Deep Space Navigation (beyond the moon)
"Navigation between the Planets" by William G. Melbourne; Scientific American; June 1976, pp 58-74.
"Formulation for Observed and Computed Values of Deep Space Network Data Types for Navigation" by Theodore D. Moyer; John Wiley and Sons; 2003; ISBN 0-471-44535-5.
